...
public final class QComponentHost extends QComponentHostNative {
    ...
    public QComponentHost(final Component hostedComponent, QWidget parent) {
        ...
        System.out.println("QCOMPONENTHOST");
    }
    ...
    public void resizeEvent(QResizeEvent e) {
        ...
        System.out.println("RESIZE EVENT " + e.size().width() + "    " +  e.size().height());
    ...
    public QSize minimumSizeHint() {
        ...
        System.out.println("MINIMUM SIZE HINT " + dim.width + "    " +  dim.height);
    ...
    public QSize sizeHint() {
        ...
        System.out.println("PREFERRED SIZED HINT " + d.width + "    " +  d.height);
