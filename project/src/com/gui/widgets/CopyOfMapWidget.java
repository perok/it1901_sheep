...
import com.trolltech.research.qtjambiawtbridge.*;

/** Stream an external source of media
 * 
 * @author Gruppe 10 <3
 */
public class CopyOfMapWidget extends JXMapKit
{
	
	/** Constructor. Initialize..
	 */
	public CopyOfMapWidget()
	{
	...
	private void initWidget()
	{
		...
		//this.addMouseListener(new CenterMapListener(mapKitChild));
		//this.addMouseWheelListener(new ZoomMouseWheelListenerCenter(mapKitChild));
		//this.addKeyListener(new PanKeyListener(mapKitChild));
		
		this.setTileFactory(wmsTileFactory);	
		this.setVisible(true);
		this.setZoom(1);
		this.setAddressLocation(trondheimLocation);
	...
	{
		//this.qhbLayout = new QGridLayout();
		super.setLayout(this.qhbLayout);
		
		mapKit.setMinimumSize(new Dimension(200, 200));
		mapKit.setSize(new Dimension(300, 300));
		//this.setLayout(qhbLayout);
		//qhbLayout.addLayout(verticalLayout, 0, 0, 1, 1);
	
		this.qhbLayout.addWidget(new QComponentHost(mapKit, this), 0 ,0, 1, 1);
