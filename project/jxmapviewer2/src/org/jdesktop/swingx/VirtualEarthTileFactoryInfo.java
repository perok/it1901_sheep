...
public class VirtualEarthTileFactoryInfo extends TileFactoryInfo {
	 ...
	 * Use satellite map
	 */
	public final static MVEMode SATELLITE = new MVEMode("satellite",
			"satellite", "a", ".jpeg");

	/**
	 * Use hybrid map
	 */
	public final static MVEMode HYBRID = new MVEMode("hybrid", "hybrid", "h",
			".jpeg");
	...
	public static class MVEMode {
		...
		private MVEMode(final String name, final String label,
	...
	public VirtualEarthTileFactoryInfo(MVEMode mode) {
		super(MIN_ZOOM_LEVEL, MAX_ZOOM_LEVEL, TOP_ZOOM_LEVEL, TILE_SIZE, false,
				false, "", "", "", "");
