...
public class MainWindow extends QMainWindow
{
    ...
    private void createStatisticsWidget()
    {
    	...
    	//super.setCentralWidget(swStatistics);
    	//super.addDockWidget(Qt.DockWidgetArea.TopDockWidgetArea, this.swStatistics);
    	super.addDockWidget(Qt.DockWidgetArea.DockWidgetArea_Mask, this.swStatistics);
    }
    
    private void createMapWidget()
    {
    	this.mwWidget = new MapWidget();
    	this.setCentralWidget(this.mwWidget);
    }
    ...
    {
        QMessageBox.information(this, "Info", "Protype for Sheep-monitoring :)");
    }
}
